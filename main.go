...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "  -emails         		Gives the result on the basis of email provided\n")
		fmt.Fprintf(os.Stderr, "  -domainName     		Gives the result on the basis of domain name provided\n")
		fmt.Fprintf(os.Stderr, "  -guids          		Gives the result on the basis of guids provided\n")
		fmt.Fprintf(os.Stderr, "  -urls         		Gives the result on the basis of urls provided\n")
		fmt.Fprintf(os.Stderr, "  -s3Domain  			Gives the result on the basis of s3Domains provided\n")
		fmt.Fprintf(os.Stderr, "  -apiPath  			Gives the result on the basis of apiPath provided\n")
		fmt.Fprintf(os.Stderr, "  -ipv4addresses  		Gives the result on the basis of ipv4addresses provided\n")
		fmt.Fprintf(os.Stderr, "  -ipv6addresses  		Gives the result on the basis of ipv6addresses provided\n")
		fmt.Fprintf(os.Stderr, "  -jwtTokens  			Gives the result on the basis of jwtTokens provided\n")
		fmt.Fprintf(os.Stderr, "  -socialMediaUrls  	Gives the result on the basis of socialmediaurls provided\n")
		fmt.Fprintf(os.Stderr, "  -gqlFragment  		Gives the result on the basis of gqlfragment provided\n")
		fmt.Fprintf(os.Stderr, "  -extractedDomains  	Gives the result on the basis of extracteddomains provided\n")
		fmt.Fprintf(os.Stderr, "  -extractedUrls  		Gives the result on the basis of extractedurls provided\n")
		fmt.Fprintf(os.Stderr, "  -vulnerabilities  	Gives the result on the basis of vulnerabilities provided\n")
		fmt.Fprintf(os.Stderr, "  -nodeModules  		Gives the result on the basis of nodemodules provided\n")
		fmt.Fprintf(os.Stderr, "  -fileExtensionUrls  	Gives the result on the basis of fileExtensionUrls provided\n")
		fmt.Fprintf(os.Stderr, "  -domainStatus  		Gives the result on the basis of domainstatus provided\n")
		fmt.Fprintf(os.Stderr, "  -gqlQuery  			Gives the result on the basis of gqlquery provided\n")
		fmt.Fprintf(os.Stderr, "  -gqlMutation  		Gives the result on the basis of gqlMutation provided\n")
		fmt.Fprintf(os.Stderr, "  -queryParamsUrls  	Gives the result on the basis of queryparamsurls provided\n")
		fmt.Fprintf(os.Stderr, "  -filteredPortUrls  	Gives the result on the basis of filteredporturls provided\n")
		fmt.Fprintf(os.Stderr, "  -s3DomainsInvalid  	Gives the result on the basis of s3domainsinvalid provided\n")
		fmt.Fprintf(os.Stderr, "  -localhosturls  		Gives the result on the basis of localhosturls provided\n")
